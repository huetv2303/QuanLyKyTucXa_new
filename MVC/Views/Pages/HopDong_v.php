...
<body>
    ...
    <form action="http://localhost/qlktx/HopDong/timkiem" class="text-center padd" method="post"> <!-- form tìm kiếm -->
        ...
        <div class="text-center padd">
            <a href="http://localhost/qlktx/HopDongThem" class="btn btn-primary">+ Thêm mới</a>
            <a href="http://localhost/qlktx/HopDongFile" class="btn btn-outline-primary">Nhập excel</a>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <!-- <a href="">Xóa</a> -->
                            <a href="http://localhost/qlktx/HopDong/sua/<?php echo $row['maHopDong'] ?>" class="btn btn-outline-primary">Sửa</a>
                            <a href="http://localhost/qlktx/HopDong/xoa/<?php echo $row['maHopDong'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ko?')" class="btn btn-outline-danger">Xóa</a>
