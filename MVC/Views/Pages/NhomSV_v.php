...
<body>
    <div class="main">
        ...
        <form method="post" action="http://localhost:2929/QuanLyKyTucXa_new/NhomSV/themmoi" id="addInvoiceForm">
            <!-- Modal -->
            <div class="modal-add">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.maToa').change(function() {
                    ...
                    if (maToa !== '') {
                        $.ajax({
                            url: 'http://localhost:2929/QuanLyKyTucXa_new/NhomSV/get_phong_by_toa',
                            method: 'POST',
                            data: {
                                maToa: maToa
                            },
        ...
        <!-- gom nhom modal -->
        <form method="post" action="http://localhost:2929/QuanLyKyTucXa_new/NhomSV/update_nhomsv_ttsv" id="addInvoiceForm">
            <!-- Modal -->
            <div class="modal-add">
        ...
        <form method="post" action="http://localhost:2929/QuanLyKyTucXa_new/NhomSV/xoa_sv_khoi_nhom" id="addInvoiceForm">
            <!-- Modal -->
            <div class="modal-add">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.maNhom').change(function() {
                    ...
                    if (maNhom !== '') {
                        $.ajax({
                            url: 'http://localhost:2929/QuanLyKyTucXa_new/NhomSV/get_masv_by_nhom',
                            method: 'POST',
                            data: {
                                maNhom: maNhom
                            },
        ...
        <form method="post" action="http://localhost:2929/QuanLyKyTucXa_new/NhomSV/suadl">
            <!-- Modal -->
        ...
        <!--Hóa đơn  -->
        <form action="http://localhost:2929/QuanLyKyTucXa_new/NhomSV/timkiem" method="POST">
        ...
        <form method="post" action="http://localhost:2929/QuanLyKyTucXa_new/NhomSV/timkiem">
            <div class="form-inline">
                <div class="head_timkiem" style="padding-left: 150px;">
                    ...
                    <div>
                        <a href="http://localhost:2929/QuanLyKyTucXa_new/NhomSV" style="margin: 24px 0px" class="btn btn-success" name="btnReLoad"><i class="fa-solid fa-rotate-right"></i> Reload</a>
                    </div>
                </div>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- <a onclick="return confirm('Bạn có muốn xóa dịch vụ này không?');" href="http://localhost:2929/QuanLyKyTucXa_new/NhomSV/xoa/<?php echo $row['maNhomSinhVien'] ?>" class="btn btn-outline-danger"><i style="color: red;" class="fa-solid fa-trash"></i></a> -->
                                    </td>
                                </tr>
                        <?php
                            }
