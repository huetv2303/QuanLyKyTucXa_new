                    ...
                    <form class="content1" action="http://localhost/QuanLyKyTucXa_new/HopDong/suadl" method="post">
                        ...
                        ?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <select required style="width:700px" class="selectpicker form-select" name="txtMaNhanVien" id="nhanvien">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <select required style="width:700px" class="form-select maToa" name="txtMaToa" id="maToa">
                                            <option value="">-------Chọn--------</option>
                                            <?php
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <select required style="width:700px" class="form-select maPhong" name="txtMaPhong" id="maPhong">
                                            <option value="">-------Chọn--------</option>
                                            <?php
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <input required type="date" name="txtNgayBatDau" class="form-control" id="nbd" style="width:700px" value="<?php echo $row['ngayBatDau'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <input required type="date" name="txtNgayKetThuc" class="form-control" id="nkt" style="width:700px" value="<?php echo $row['ngayKetThuc'] ?>">
                                    </div>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <button type="submit" class="btn btn-primary" name="btnLuu" value="SỬA">SỬA</button>
                            </div>
                        </div>
                    </form>
        </div>
