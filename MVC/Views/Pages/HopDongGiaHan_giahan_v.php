                        ...
                        ?>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select disabled style="width:700px" class="input_tb form-select" name="txtMaNhanVien" id="nhanvien" value="<?php echo $row['ManNhanVien'] ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select disabled  style="width:700px" class="input_tb form-select" name="txtMaSinhVien" id="sinhvien">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select disabled  style="width:700px" class="input_tb form-select" name="txtMaPhong" id="phong">
                                    ...
                                    <tr>
                                        ...
                                        <td><input readonly type="date" name="txtNgayBatDau" class="form-control" id="nbd" value="<?php echo $row['ngayBatDau'] ?>"></td>
                                    </tr>
                                    <tr>
