...
<form method="post" action="http://localhost:9090/QuanLyKyTucXa_new/HoaDonGuiXe/UpdateData">
        <div class="form-group">
            ...
            ?>
                    ...
                    <input type="text" class="form-control" name="txtBillCode" value="<?php echo $row['billCode'] ?>" readonly>
                    <label>Mã sinh viên</label>
                    <input type="text" class="form-control" name="txtID" value="<?php echo $row['ID'] ?>" readonly>
                    <label>Tên sinh viên</label>
                    <input type="text" name="txtName" class="form-control"  value="<?php echo $row['studentName']?>" readonly>
                    <label>Tháng</label>
                    ...
                    <input type="date" class="form-control" name="txtDay" value="<?php echo $row['invoiceDate'] ?>">
                    <label>Loại xe</label>
                    <input type="text" class="form-control" name="txtType" value="<?php echo $row['vehicle'] ?>" readonly>
                    <label>Biển số xe</label>
                    <input type="text" class="form-control" name="txtPlate" value="<?php echo $row['plate'] ?>" readonly>
                    ...
                    <label>Ghi chú</label>
                    <input type="text" class="form-control" name="txtNote" value="<?php echo $row['note'] ?>">
            <?php
                }
            }
            ?>
